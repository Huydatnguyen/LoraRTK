...
#define RFBUSY 26                               //busy line

#define LED1 2                                  //on board LED, high for on
#define DIO1 33                                 //DIO1 pin on LoRa device, used for RX and TX done 
#define DIO2 25                                 //DIO2 pin on LoRa device, normally not used so set to -1 
